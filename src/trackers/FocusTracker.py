...
class FocusTracker:
    ...
    def __init__(self, baseline_mode=False, testing=False):
        ...
        self.wakeuphr = int(wakehr)
        self.wakeupmin = int(wakemin)
        self.bedtimehr = int(bedhr)
        self.bedtimemin = int(bedmin)
        # print(self.wakeuphr)
        # print(self.wakeupmin)
        # print(self.bedtimehr)
        # print(self.bedtimemin)
        self.i=0
        self.j=0
    ...
    def get_state(self):
        ...
        #     if(not self.snooze_on and self.cozmo_active):
        ...
        if(not self.is_standing()):
            ...
            if self.istime(hours, minutes, self.wakeuphr, self.wakeupmin):
                self.log_message = 'call,cozmo,ongoing'
                return_state = UserBreakState.NeedCozmow
            else:
                self.log_message = 'not time'
        ...
        # If we are already awake and need to go to bed 
            ...
            # print(minutes)
            second = current_time.second
            if self.istime(hours, minutes, self.bedtimehr, self.bedtimemin):
                self.log_message = 'call,cozmo,ongoing'
        ...
        # If we don't meet any of the break stuff then no break is needed
            ...
            self.log_message = 'not standing or sitting'
            return_state = UserBreakState.NoBreak
...
# //////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    def istime(self, hr,min,targhr,targmin,margin=45):
        current_time = datetime.now()
